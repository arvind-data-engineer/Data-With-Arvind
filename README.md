...
The contact form posts to FormSubmit so it can send project requests to `data_with_arvind@gmail.com` on static hosting. After publishing, send one test message and confirm the activation email from FormSubmit.
